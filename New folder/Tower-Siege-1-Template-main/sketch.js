...
function draw() {
  ...
  textSize(20);
  fill("lightyellow");
  text("Drag the polygon to destroy the block",200,30);
  textSize(10);
  ...
  block6.display();
  block7.display();
  fill("rgb(254, 141, 123)");
  block8.display();
  block9.display();
  block10.display();
  block11.display();
  block12.display();
  fill("rgb(255, 182, 141)");
  block13.display();
  block14.display();
  block15.display();
  fill("rgb(252, 203, 143)");
  block16.display();
  ...
  blocks20.display();
  blocks21.display();
  fill("rgb(250, 240, 207)");
  blocks22.display();
  blocks23.display();
  blocks24.display();
  fill("rgb(251, 240, 237)")
  blocks25.display();
  fill("gold");
  imageMode(CENTER)
